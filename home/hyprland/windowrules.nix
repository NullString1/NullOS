{ ... }:
{
  wayland.windowManager.hyprland = {
    settings = {
      windowrulev2 = [
        "tag +file-manager, class:^([Tt]hunar|org.gnome.Nautilus|[Pp]cmanfm-qt|[Dd]olphin)$"
        ...
        "tag +vpn, class:^(Mullvad VPN|Cloudflare Zero Trust)$"
        ...
        "float, tag:settings*"
        "float, class:^(Mullvad VPN|Cloudflare Zero Trust)$"
        "workspace special, class:^(Mullvad VPN)$"
        "move 75% 5%, class:^(Mullvad VPN)$"
        "size 300 400, class:^(Mullvad VPN)$"
